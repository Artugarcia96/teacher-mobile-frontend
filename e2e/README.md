...
| Alumnos | `alumnos-lista`, `alumnos-anadir`, `alumnos-ficha`, `alumnos-apoyos`, `alumnos-observaciones`, `alumnos-vigilar`, `alumnos-quitar`, `alumnos-buscar`, `alumnos-red`, `alumnos-teclado` | Lista de la clase, Añadir alumnos (pegar, archivo, otro grupo), ficha, datos y apoyos, observaciones, A vigilar, quitar de un grupo, búsqueda, sin conexión y teclado |
