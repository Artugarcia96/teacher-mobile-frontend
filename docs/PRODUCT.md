...
- Con el montón escaneado, una fila **«24 de 26 hojas recibidas · Faltan Pérez, Ruiz»** abre la hoja de NP o repesca (también para quien no hizo el examen sin constar ausente en la lista). «Faltaron N» en la cabecera sale solo antes de escanear.
...
3. **Revisar**: la IA sugiere puntos por pregunta contra la rúbrica, viendo todas las páginas del alumno, también los reversos escritos y las hojas extra (que en la revisión aparecen al final, marcadas «Hoja extra · ej. 4»), dice dónde está cada respuesta y resume la hoja en **una línea factual sin la nota** («Todo correcto; en 3b falta simplificar 30/36»). La nota = suma de puntos confirmados (escalada a la nota máxima). Siempre se puede teclear la nota a mano sin papel.
   ...
   - **Modo foco** alumno a alumno. Cabecera: «‹ Examen U2 · Fracciones» (volver), el alumno y «7 de 24 · faltan 18»; «···» con Ordenar páginas y **Marcar NP** (pide confirmación, y más si tiene páginas escaneadas). Entra siempre por el primer alumno sin revisar; en el último pendiente el botón es **«Aceptar y terminar»** y vuelve a la actividad con «24 de 24 revisados»; al salir antes, «Revisión guardada · 7 de 24», y la actividad vuelve a la misma posición.
     - Cada pregunta: enunciado en una línea (se despliega al tocarlo), **recorte de la respuesta del alumno** (en un examen generado, donde se imprimió la pregunta; en uno subido, donde la leyó la IA; las hojas extra en las que el alumno indica esa pregunta; el recorte sigue a su página aunque se reordene), la frase de la IA, «Solución» y los puntos; «IA: 1» solo si el profesor cambió lo que propuso. Comentario opcional: sale en la ficha del alumno junto a la nota.
     - Móvil: la hoja entera tras **«Ver hoja»** (visor con zoom); barra fija abajo, opaca, con «‹ Anterior» y «Aceptar y siguiente», y el contenido termina encima de ella. Escritorio: la hoja a la izquierda sigue a la pregunta en foco (marcada con un recuadro), flechas ‹ › en la cabecera, Enter acepta.
     - **Nombre por confirmar**: si el nombre leído no casó con seguridad, arriba «Nombre por confirmar: se lee «Jorge Can»» con [Es correcto] [Cambiar]; hasta confirmarlo no se puede aceptar la nota (ni poner NP).
