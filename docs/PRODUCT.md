...
1. **Preparar**: sin documento (solo nota) · subir mi examen (PDF/fotos) · generar con IA desde unidades. Si hay documento, la IA extrae la **rúbrica** (preguntas, puntos, solución) → el profesor la revisa en una tabla compacta. Descargas: examen para imprimir (se fotocopia **el mismo** para todos; cabecera "Nombre y apellidos ____"), **hoja extra** (folio pautado con nombre y "Ejercicio nº ___" para quien necesite más espacio), soluciones. En un examen generado, guardar la rúbrica actualiza el PDF («Guardar y actualizar el PDF»).
   ...
   - **Versiones** (sección de Preparar, con el examen ya preparado). El profesor de Secundaria necesita un «modelo B» para que dos alumnos sentados juntos no tengan el mismo examen y versiones adaptadas para el alumnado NEAE; hoy son horas de copiar y pegar en Word.
     ...
     - **Adaptaciones en esta clase**: los alumnos con medidas y sus chips, qué versión hacen, un recordatorio de las medidas que no cambian el documento («Más tiempo: Mario, Lucía · Lectura en voz alta: Iker») y **«Preparar versiones adaptadas»** (con cuántos alumnos aún no tienen la versión que piden sus medidas). Una versión por combinación: letra ampliada → las mismas preguntas en letra grande (14 pt) y con más espacio, sin IA · enunciados por pasos → la IA reescribe cada enunciado en pasos numerados cortos, mismas preguntas, puntos y soluciones · examen adaptado → la IA escribe una versión con menos preguntas o más sencillas de los mismos criterios, con su rúbrica · ACS → la IA escribe un examen de los mismos temas al nivel de su ACS («5.º Primaria»), con su rúbrica. Se combinan (por pasos + letra ampliada). El modelo B se imprime con «Modelo B» junto al tipo de examen; una versión adaptada no dice que lo es.
     - **Imprimir para la clase** (bajo las versiones y en el «···»): **un** PDF en orden de lista: una hoja de reparto (nº, alumno, versión, «En el examen»: más tiempo / voz alta, casilla «Entregado» y el recordatorio) y la copia de cada alumno de su versión con su nombre impreso, así nadie reparte la copia equivocada. Cada copia empieza en hoja nueva también a doble cara. Su marca lleva el código de la versión y el nº de lista: «Sepia · FRAC-7K2-B · nº 12 · Pág. 1/2». Las versiones se pueden imprimir también sin nombres (una copia para fotocopiar de cada una).
...
3. **Revisar**: la IA sugiere puntos por pregunta contra la rúbrica **de la versión de la hoja** (la que lleva impresa, aunque el alumno se sentara con otro modelo), viendo todas las páginas del alumno, también los reversos escritos y las hojas extra (que en la revisión aparecen al final, marcadas «Hoja extra · ej. 4»), dice dónde está cada respuesta y resume la hoja en **una línea factual sin la nota** («Todo correcto; en 3b falta simplificar 30/36»). La nota = suma de puntos confirmados (escalada a la nota máxima). Siempre se puede teclear la nota a mano sin papel.
   ...
   - **Errores frecuentes** (las 3 preguntas con peor media): «P5 · Operaciones combinadas» (título corto, nunca una fórmula cortada) y «0,9 de 1,5 de media · 11 por debajo de la mitad». Suma los modelos A y B y las versiones con las mismas preguntas (por pasos, letra ampliada); las adaptadas con otras preguntas quedan fuera y se dice: «3 exámenes adaptados no cuentan en esta tabla: sus preguntas son otras». Al pie, **«Crear ficha de refuerzo con P5, P6 y P2»**: abre «Crear con IA» en la unidad del examen con una ficha de refuerzo sobre esas preguntas.
