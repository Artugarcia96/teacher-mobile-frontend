...
3. **Revisar**: la IA sugiere puntos por pregunta contra la rúbrica, viendo todas las páginas del alumno, también los reversos escritos y las hojas extra (que en la revisión aparecen al final, marcadas «Hoja extra · ej. 4»), dice dónde está cada respuesta y resume la hoja en **una línea factual sin la nota** («Todo correcto; en 3b falta simplificar 30/36»). La nota = suma de puntos confirmados (escalada a la nota máxima). Siempre se puede teclear la nota a mano sin papel.
   ...
   - **Errores frecuentes** (las 3 preguntas con peor media): «P5 · Operaciones combinadas» (título corto, nunca una fórmula cortada) y «0,9 de 1,5 de media · 11 por debajo de la mitad». Al pie, **«Crear ficha de refuerzo con P5, P6 y P2»**: abre «Crear con IA» en la unidad del examen con una ficha de refuerzo sobre esas preguntas.
